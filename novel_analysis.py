...
rule IdentifyNovelPeptides:
    ...
    params: n="1", R="'rusage[mem=8]'", J="filter_novel_peps", o="out/logs/novel_analysis/{study_group}.filter_novel_peps.out", eo="out/logs/novel_analysis/{study_group}.filter_novel_peps.err"
...
rule AdjustProteomeFastaHeaders:
    ...
    params: n="1", R="'rusage[mem=4]'", J="adjust_proteome_headers", o="out/logs/novel_analysis/{study_group}.adjust_proteome_headers.out", eo="out/logs/novel_analysis/{study_group}.adjust_proteome_headers.err"
...
rule BlastProteome:
    ...
    params: n="24", R="'span[hosts=1] rusage[mem=3]'", J="blast_proteome", o="out/logs/blast_proteome.out", eo="out/logs/blast_proteome.err"
...
rule CreateSnpEffDatabase:
    ...
    params: n="8", R="'span[hosts=1] rusage[mem=4]'", J="snpeff_db", o="out/logs/snpeff_db.out", eo="out/logs/snpeff_db.err", db_name=SNPEFF_DB
    conda: "envs/myenv.yaml"
...
rule AnnotatePredictedVariantEffects:
    ...
    params: n="16", R="'span[hosts=1] rusage[mem=4]'", J="snpEff", o="out/logs/annotate_variants.out", eo="out/logs/annotate_variants.err", \
